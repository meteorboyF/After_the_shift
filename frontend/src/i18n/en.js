...
export default {
  ...
  demo: {
    ...
    subtitle:
      'A Bangla-first, voice-first wellbeing prototype for security guards working 12-hour shifts at a university campus in Dhaka.',
    start: 'Start as a guard',
    startHint: 'This is where the real app begins',
    tasksHeading: 'The three tasks',
    task1: 'Post-shift check-in',
    task1Sub: 'Speak → who can see it → saved',
    task2: 'Post-incident grounding',
    task2Sub: 'Three options → exercise → done',
    task3: 'Relief request',
    task3Sub: 'What you need → reason → what a supervisor sees',
    screensHeading: 'Individual screens',
    home: 'Home',
    entries: 'Past entries',
    summary: 'Weekly summary',
    breathing: 'Breathing exercise',
    supervisor: 'Supervisor view',
    supervisorHint: 'Demo only — proves the privacy wall',
    helpScreen: 'Help',
    pin: 'PIN screen',
    reset: 'Reset the demo',
    resetHint: 'Clears all local data and starts fresh',
    backToDemo: 'Demo',
    notClinical: 'Course prototype — not a medical service.',
  },
